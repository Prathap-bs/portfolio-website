  ...
  return (
    <section className="hero animate-on-scroll" ref={sectionRef}>
      <div className="hero-layout">
        <div className="hero-content animate-on-scroll--left" ref={contentRef}>
        ...
        <div className="hero-visual animate-on-scroll--right" ref={visualRef} aria-hidden="true">
          <div className="hero-visual-card hero-visual-card-main glass-card">
